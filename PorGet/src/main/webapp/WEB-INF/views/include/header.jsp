...
<script src="https://kit.fontawesome.com/e7c4d675d7.js"
...
<body>
	<!-- Navigation -->
	<!-- 상단에  알람바 변경 -->
	<div id="socketAlert" class="alert alert-success" role="alert"
		style="display: none; left: 0px; top: 100px; position: fixed; z-index: 1;"></div>
	<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
		<a href="/porget" class="navbar-brand"> <img id="logo"
			class="d-inline-block mr-1" alt="Logo"
			src="/porget/img/main/dotty.svg"> <span>PorGet</span>
		</a>
		<form name="searchForm" action="searchButton" method="post">
			<input type="text" name="keyword" size="50"
				onkeydown="startSuggest()" id="searchInput"> <input
			...
			<ul class="navbar-nav ml-auto">
				...
				<c:choose>
					<c:when test="${empty uname}">
						<li class="nav-item"><a href="#myModal" class="nav-link"
							data-toggle="modal">login</a></li>
						<button onclick="location.href='join'" class="btn btn-primary">Sign
							in</button>
					</c:when>
					<c:otherwise>
						<li class="nav-item">
						...
						<div class="dropdown show">
							<a class="dropdown-toggle" href="#" role="button"
								...
								src="/porget/files/profile/${uphoto }" class="rounded-circle"
								style="width: 50px; height: 50px;">
							</a>

							<div class="dropdown-menu dropdown-menu-right"
								aria-labelledby="dropdownMenuLink">
								<div class="dropdown-item">${uname }님환영합니다!</div>
								<a class="dropdown-item" href="/porget/mypage#portfolio">포트폴리오</a>
								<a class="dropdown-item" href="/porget/mypage#bookmark">북마크</a>
								<a class="dropdown-item" href="/porget/mypage">마이페이지</a> <a
									class="dropdown-item" href="/porget/logout">로그아웃</a>
							</div>
						</div>
					...
					<form action="/porget/login" method="post">
						...
						<div class="form-group">
							<input type="password" class="form-control" name="upass"
								placeholder="Password" required="required" id="upass">
						</div>
						<div class="form-group">
