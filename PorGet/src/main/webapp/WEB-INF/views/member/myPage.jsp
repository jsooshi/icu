	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<div class="tab-content">
								...
								<div class="row no-gutters">
									...
									<div class="col-md-8">
										<div class="card-body">
											...
											<p class="card-text">
												${pvo.pfposition }<br> <small class="text-muted"><fmt:formatDate
														value="${pvo.pfdate}" pattern="yyyy-MM-dd E요일 " /></small>
											</p>
										</div>
									</div>
								</div>
				...
				<!-- like -->
				<div class="tab-pane row" id="like">
					<hr>
								...
								<div class="row no-gutters">
									...
									<div class="col-md-8">
										<div class="card-body">
											...
											<p class="card-text">
												${like.pfposition }<br> <small class="text-muted"><fmt:formatDate
														value="${like.pfdate}" pattern="yyyy-MM-dd E요일 " /></small>
											</p>
										</div>
									</div>
								</div>
				...
				<div class="tab-pane" id="setting">
					...
					<div class="form-group">
						<label for="uphotoFile">프로필 사진 변경(.jpg/.jpeg/.png/.gif)</label> <input
							type="file" class="form-control" id="uphotoFile"
							name="uphotoFile" placeholder="파일첨부" tabindex="6"
							accept=".jpg,.png,.gif,.jpeg" title="파일등록" hidden> <label
							for="uphotoFile" class="form-control">사진을 선택하세요</label>
						<button type="button" class="btn btn-start-order"
							id='changeUphoto'>프로필 사진 변경</button>
					</div>
					<div class="form-group">
